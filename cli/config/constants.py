...
CODE_DIR = "code"
DOCS_DIR = "docs"
AIDLC_DOCS_SUBDIR = "docs"
RE_SKILLS_SUBDIR = "skills"

# Platforms with native saved-prompt support use an absolute path (~ expanded at runtime).
# Platforms without native support fall back to prompts/ in the framework workspace root.
PLATFORM_MAPPINGS = {
    "amazon-q": {
        ...
        "single_file": False,
        "prompts_path": "~/.aws/amazonq/prompts/",  # native @prompt support
        "prompts_native": True,
    },
    "kiro": {
        "display_name": "Kiro",
        ...
        "single_file": False,
        "prompts_path": "~/.kiro/prompts/",  # native @prompt support
        "prompts_native": True,
    },
    "cursor": {
        "display_name": "Cursor",
        ...
        "single_file": True,
        "prompts_path": "prompts/",  # workspace-relative, manual reference
        "prompts_native": False,
    },
    "cline": {
        "display_name": "Cline",
